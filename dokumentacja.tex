...
Aby uzyskać możliwość rezerwowania stolików klient musi być zalogowany. W tym celu należy się zalogować (widok na rys. \ref{fig:login}) lub zarejestrować (widok na rys. \ref{fig:register}) z potwierdzeniem e-mailowym założenia konta. Po zalogowaniu fakt nazwa użytkownika będzie widoczna zamiast przycisku zaloguj na pasku nawigacyjnym (rys. \ref{fig:loged_in}). Jeżeli użytkownik zapomniał hasła może je zresetować\ref{fig:reset}.
...
\centering
	...
	\caption[caption]{Rezerwacje klientów w restauracji.}
\end{figure}
